...
def test_empty (alt):
    assert lt.isEmpty(alt) == True
    assert lt.size(alt) == 0



def test_addFirst (alt, books):
    assert lt.isEmpty(alt) == True
    assert lt.size(alt) == 0
...
def test_getElement(altbooks, books):
...
def test_removeFirst (altbooks, books):
...
def test_removeLast (altbooks, books):
    assert lt.size(altbooks) == 5
...
def test_insertElement (alt, books):
...
def test_isPresent (altbooks, books):
    book = {'book_id':'10', 'book_title':'Title 10', 'author':'author 10'}
...
def test_deleteElement (altbooks, books):
...
def test_exchange (altbooks, books):
